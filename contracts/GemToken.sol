 ...
 * @dev see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md
 */
contract GemToken is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721, Ownable, Fallback {
  ...
  /*** CONSTANTS ***/
  string public constant company = "EtherChest, LLC";
  ...
  function buyToken (
	...
	// will be implemented during open beta
